...
'projectkalpa', ngo: true) projectkalpa.save!

rajmachi_rural_aid = User.new(email: 'admin@rajmachiruralaid.org', password:
'ruralaid', ngo: true) rajmachi_rural_aid.save!
...
'bunky123', ngo: false) traveler.save!
...
bali_photos_one = [ seed_image(L1840124-1184x662) ]
...
that are located ",  guided: true   )
  ...
  bali_experience_one.areatypes << [areatype.sample]
  bali_experience_one.photo_urls = bali_photos_one
  bali_experience_one.save!



bali_photos_two = [ seed_image(L1840124-1184x662) ]
...
bali_experience_two.areatypes << [areatype.sample]
bali_experience_two.photo_urls = bali_photos_two
bali_experience_two.save!


bali_photos_three = [ seed_image(L1840124-1184x662) ]
...
International Airport. For those that are located "   guided: true   )
  ...
  bali_experience_three.areatypes << [areatype.sample]
  bali_experience_three.photo_urls = bali_photos_three
  bali_experience_three.save!



rajmachi_fund_one = Fund.new(   user: project_kalpa,   funding_goal: 5000,
title: "Improve Living Conditions of Community",   about: "Rajmachi fort has
...
order to ensure their children’s education.",   use_of_funds: "Their aim was and
...
with a lot of ATMs and drive in restaurants.", guided: true   )
  ...
  rajmachi_experience_one.areatypes << [areatype.sample]
...
excellent condition with a lot of ATMs and drive in restaurants."   guided: true
  ...
  rajmachi_experience_two.areatypes << [areatype.sample]
  rajmachi_experience_two.photo_urls = rajmachi_photos_two
  rajmachi_experience_two.save!



features = [   Feature.create!(name: "Power", fa_icon: "fa-plug"),
...
Feature.create!(name: "Wi-Fi", fa_icon: "fa-wifi"),   Feature.create!(name:
"Mobile Connection", fa_icon: "fa fa-mobile"),   Feature.create!(name: "Private
Accomodation", fa_icon: "fa fa-bed"),   Feature.create!(name: "Shared
Accomodation", fa_icon: "fa fa-users"),   Feature.create!(name: "Fresh Water
Supply", fa_icon: "fa fa-tint"),   Feature.create!(name: "Overhead Shower",
fa_icon: "fa fa-shower") ]

activities = [  Activity.create!(name: "Hiking", fa_icon: "fa-blind"),
...
Activity.create!(name: "Cycling", fa_icon: "fa fa-wrench") ]


areatypes = [   Areatype.create!(name: "Farm", fa_icon: "fa fa-sun-o"),
Areatype.create!(name: "Mountainous", fa_icon: "glyphicons glyphicons-
mountains"),   Areatype.create!(name: "Desert", fa_icon: "fa fa-sun-o"),
Areatype.create!(name: "Rainforest", fa_icon: "fa fa-leaf"),
Areatype.create!(name: "Jungle", fa_icon: "fa fa-wifi"),
Areatype.create!(name: "Woods", fa_icon: "fa-tree"),   Areatype.create!(name:
"Plains", fa_icon: "fa fa-wifi") ]
