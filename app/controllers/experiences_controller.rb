class ExperiencesController < ApplicationController
  ...
  private
    ...
    def experience_params
      params.require(:experience).permit(:short_description, :long_description, :title, :price, :capacity, :address, :city, :country, :duration, :postal_code, :fund_id, photos: [], feature_ids: [], activity_ids: [], areatype_ids: [])
    end
end
